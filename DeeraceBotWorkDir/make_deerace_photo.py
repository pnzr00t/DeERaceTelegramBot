...
def make_deerace_photo(project_name='deerace', data_root_path='datasets/deerace/testA', results_dir='./results/'):
    ...
    for i, data in enumerate(dataset):
        ...
        save_image_result = save_images(webpage, visuals, img_path, aspect_ratio=opt.aspect_ratio, width=opt.display_winsize)
